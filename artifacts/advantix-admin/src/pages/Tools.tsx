...
const PROVIDERS: Array<{ id: Provider; label: string; icon: string; defaultModel: string; models: string[]; color: string; keyHint: string }> = [
  ...
  { id: "openrouter", label: "OpenRouter", icon: "🔀", defaultModel: "anthropic/claude-3-5-sonnet",  models: ["anthropic/claude-3-5-sonnet", "openai/gpt-4o", "google/gemini-2.0-flash-001", "meta-llama/llama-3.1-70b-instruct", "z-ai/glm-5.1", "thudm/glm-4-32b", "thudm/glm-z1-32b"], color: "border-violet-500/40 bg-violet-500/5 text-violet-400", keyHint: "OPENROUTER_API_KEY" },
